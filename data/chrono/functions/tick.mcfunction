...
execute at @e[type=marker,tag=startchrono] if entity @a[distance=0..5,nbt={SelectedItem:{id:"minecraft:stick"}}] run particle minecraft:happy_villager ~ ~ ~ 0.1 0.5 0.1 1 1 normal